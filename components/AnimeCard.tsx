...
import { ExternalLink, Calendar, Film, PlayCircle, Info } from 'lucide-react';
...
const AnimeCard: React.FC<AnimeCardProps> = ({ anime, index }) => {
  return (
    <div 
      className="bg-slate-800 rounded-xl overflow-hidden shadow-lg border border-slate-700 hover:border-indigo-500 transition-all duration-300 flex flex-col md:flex-row animate-fadeIn"
      style={{ animationDelay: `${index * 150}ms` }}
    >
      {/* Image Section */}
      <div className="md:w-1/3 relative group overflow-hidden bg-slate-900 min-h-[300px] md:min-h-0">
        <img 
